...
export async function POST(req: Request) {
  try {
    ...
    // email (the storefront owner). The authenticated developer
    // is stored separately in developer_email. Matching
    // user_email against the developer's session email would
    // never succeed unless the developer happened to also be
    // the client -- that was the bug that made every invite
    // creation fail with a false permission error.
    // ---------------------------------------------------------
